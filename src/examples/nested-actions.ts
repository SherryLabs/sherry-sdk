...
export const onboardingFlowApp: ActionFlow = {
    ...
    actions: [
        // Step 1: Email signup form
        {
            ...
            nextActions: [{ actionId: 'wallet-decision' }],
        } as NestedHttpAction,
            ...
            options: [
                {
                    ...
                    value: 'has-wallet',
                    nextActionId: 'connect-wallet',
                },
                {
                    label: 'No, I need to create one',
                    value: 'no-wallet',
                    nextActionId: 'create-wallet-guide',
                },
            ],
        } as DecisionAction,
        ...
        // Step 3B: Wallet creation guide
        {
            ...
            nextActions: [{ actionId: 'wallet-creation-completion' }],
        } as NestedHttpAction,
        ...
        // Step 4B: Completion for new wallet users
        {
            ...
            message:
                'Follow the guide to create your wallet, then return to claim your welcome NFT!',
            status: 'success',
        } as CompletionAction,
        ...
        // Step 5: Final completion
        {
            ...
            message:
                "Welcome to Sherry! Your account is set up and you've received your first NFT.",
            status: 'success',
        } as CompletionAction,
    ],
};
...
export const governanceFlowApp: ActionFlow = {
    ...
    actions: [
            ...
            options: [
                {
                    ...
                    value: 'create',
                    nextActionId: 'create-proposal-form',
                },
                {
                    label: 'Vote on Proposals',
                    value: 'vote',
                    nextActionId: 'vote-proposal-selection',
                },
                {
                    label: 'Execute a Proposal',
                    value: 'execute',
                    nextActionId: 'execute-proposal-selection',
                },
            ],
        } as DecisionAction,
        ...
        // Create proposal flow
        {
            ...
            nextActions: [{ actionId: 'review-proposal' }],
        } as NestedHttpAction,
        ...
        // Vote on proposal flow
        {
            ...
            nextActions: [{ actionId: 'vote-decision' }],
        } as NestedHttpAction,
        ...
        // Execute proposal flow
        {
            ...
            nextActions: [{ actionId: 'confirm-execution' }],
        } as NestedHttpAction,

        {
            ...
            options: [
                {
                    label: 'Yes, execute proposal',
                    value: 'execute',
                    nextActionId: 'execute-proposal',
                },
        ...
        // Completion states for all paths
        {
            ...
            message:
                'Your proposal has been successfully created! Proposal ID: {{lastResult.data.proposalId}}',
            status: 'success',
        } as CompletionAction,
