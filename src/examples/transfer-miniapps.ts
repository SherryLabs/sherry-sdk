import { TransferAction, SelectOption } from '../interface/transferAction';
  ...
  actions: [
    // Transfer with recipient selection
    {
      ...
      recipient: {
        ...
        required: true,
        options: [
          { label: 'Education Fund', value: '0x1234567890123456789012345678901234567890', description: 'Supporting education initiatives' },
          { label: 'Climate Action', value: '0x2345678901234567890123456789012345678901', description: 'Fighting climate change' },
          { label: 'Healthcare Access', value: '0x3456789012345678901234567890123456789012', description: 'Improving healthcare access' }
        ]
      },
      amountConfig: {
        defaultValue: 0.1
