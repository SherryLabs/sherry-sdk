...
export class DynamicActionExecutor {
    async resolve(action: DynamicAction, context?: Record<string, any>): Promise<ExecutionResponse> {
        ...
        try {
            ...
            console.error(`[DynamicActionExecutor] Error resolving action '${action.label}': ${message}`);
