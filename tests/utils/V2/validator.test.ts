...
describe('Radio Parameter Validation', () => {
  ...
  it('throws error when radio parameter has less than 2 options', () => {
    ...
    expect(() => validateBlockchainParameters([invalidRadioParam], abiParams))
      .toThrow(ActionValidationError);
    expect(() => validateBlockchainParameters([invalidRadioParam], abiParams))
      .toThrow(/debe tener al menos 2 opciones/);
  });
  ...
  it('throws error when radio parameter default value is not in options', () => {
    ...
    expect(() => validateBlockchainParameters([invalidRadioParam], abiParams))
      .toThrow(ActionValidationError);
    expect(() => validateBlockchainParameters([invalidRadioParam], abiParams))
      .toThrow(/no está entre las opciones disponibles/);
  });
...
describe('Block Action Metadata Validation', () => {
  ...
  it('throws error for invalid address', () => {
    ...
    expect(() => validateBlockchainActionMetadata(invalidAction)).toThrow(ActionValidationError);
  ...
  it('throws error for non-existent function in ABI', () => {
    ...
    expect(() => validateBlockchainActionMetadata(invalidAction)).toThrow(ActionValidationError);
    expect(() => validateBlockchainActionMetadata(invalidAction)).toThrow(/no existe en el ABI/);
  });
...
describe('Template parameters validation', () => {
  it('validates standard parameter templates', () => {
    ...
    expect(() => validateBlockchainParameters(
