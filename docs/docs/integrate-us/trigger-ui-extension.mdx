...
async function writeContract(tabId: number, payload: any) {
  ...
  try {
    ...
    const encodedData = providedData ?? encodeFunctionData({
...
<div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-6">
  <div className="border rounded-lg p-4">
    ...
    <p className="text-sm text-gray-600">
      <a href="https://developer.chrome.com/docs/extensions/" className="text-blue-600 hover:underline">
  ...
  <div className="border rounded-lg p-4">
    ...
    <p className="text-sm text-gray-600">
      <a href="https://github.com/orgs/SherryLabs/repositories" className="text-blue-600 hover:underline">
        GitHub Issues
      </a>
    </p>
  </div>
