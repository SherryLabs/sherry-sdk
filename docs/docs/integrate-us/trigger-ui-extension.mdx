...
export function PopupApp() {
  ...
  return (
    <div className="min-h-[400px] bg-white p-4">
      ...
      <div className="mb-4">
        <button onClick={() => setActiveTab('wallet')} className={activeTab === 'wallet' ? 'font-bold' : ''}>Wallet</button>
        <button onClick={() => setActiveTab('settings')} className={activeTab === 'settings' ? 'font-bold' : ''}>Settings</button>
        <button onClick={() => setActiveTab('about')} className={activeTab === 'about' ? 'font-bold' : ''}>About</button>
      </div>
