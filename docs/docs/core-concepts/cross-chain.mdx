...
As you can see, Celo (42220) has been defined as destination, this will be interpreted as cross-chain by Sherry (from Avalanche to Celo).
...
- `chains`: The blockchains where the action will take place (e.g., 43114 - 42220).
