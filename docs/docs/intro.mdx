...
- 🧩 **Multiple Action Types**:
  ...
  - **HTTP Actions**: Integrate with external APIs and services.
...
1. **[Create Your First Mini-App](./keyconcepts/creatingminiapp.mdx)** - Start with the basics
2. **[View Examples](./keyconcepts/examples.md)** - See working examples
3. **[Follow the Complete Guide](./guides/guide-en.md)** - Step-by-step tutorial

### Core Concepts

- **[Understanding Actions](./keyconcepts/actions.md)** - Learn about different action types
- **[Metadata Structure](./keyconcepts/metadata.md)** - Understand the mini-app definition format
- **[Chain Support](./chainlogic/chains.md)** - Multi-chain and cross-chain capabilities
