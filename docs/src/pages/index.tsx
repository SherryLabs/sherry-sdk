                        ...
                        <div className={styles.mockupContainer}>
                            ...
                            <div className={styles.socialPost}>
                                ...
                                <div className={styles.postContent}>
                                    <p>
                                        🚀 Just launched our new NFT collection! Mint directly from
                                        this post:
                                    </p>
    ...
    const features = [
        {
            ...
            icon: <FaGlobe />,
            description:
                'Deploy once, run everywhere. Support for Avalanche, Celo, Ethereum, and more.',
            highlights: [
        ...
        },
        {
            ...
            icon: <FaLightbulb />,
            description:
                'From simple transfers to complex multi-step flows with conditional logic.',
            highlights: [
        ...
        <section className={styles.featuresSection}>
            <div className="container">
                <div className={styles.sectionHeader}>
                    ...
                    <p>
                        Everything you need to build the next generation of social Web3 experiences
                    </p>
                </div>
        ...
        <section className={styles.quickLinksSection}>
            <div className="container">
                <div className={styles.sectionHeader}>
                    ...
                    <p>
                        Whether you're new to Web3 or an experienced developer, we have the right
                        starting point
                    </p>
                </div>
                <div className={styles.quickLinksGrid}>
                    {quickLinks.map((link, idx) => (
                        <Link key={idx} to={link.url} className={styles.quickLinksCard}>
                            ...
                            <Heading as="h4" className={styles.quickLinksTitle}>
                                {link.title}
                            </Heading>
        ...
        <section className={styles.ctaSection}>
            <div className="container">
                <div className={styles.ctaContent}>
                    ...
                    <p>
                        Join thousands of developers creating the next generation of social Web3
                        experiences. Start building your first mini-app today.
                    </p>
